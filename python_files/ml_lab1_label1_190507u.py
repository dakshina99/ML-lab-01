# -*- coding: utf-8 -*-
"""ML-lab1-label1-190507U.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Uwm74B4xiKRHfKTmp0G0NiqYMg3NtGHs
...
"""Retrieve the first target label from the training, validation, and testing datasets."""
...
"""Duplicate the label 1 of the datasets to be used in the models without feature engineering"""
...
"""Used the trained model on all features to predict and get metrics for the traing set and the valid set"""
...
print(f"Metrics for the best model on train data:")
...
print(f"Metrics for the best model on valid data:")
print(f"Accuracy: {accuracy:.2f}")
print(f"Precision: {precision:.2f}")
print(f"Recall: {recall:.2f}")
print("\n")

"""Predict the label 1 on test dataset"""
...
correlation_with_target = pca_train_result_df.corrwith(train_label1)
...
for model_name, model in classification_models:
    ...
    model.fit(train_features, train_label1)
...
destination = '/content/drive/MyDrive/AI-Resources/ML/LAB01/190507U_label_1.csv'
