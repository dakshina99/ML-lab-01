# -*- coding: utf-8 -*-
"""ML-lab1-label3-190507U.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S7AwK_8t86TSo12tJm2cE_hyu1RjVGf3
...
"""Retrieve the third target label from the training, validation, and testing datasets."""
...
"""Duplicate the label 3 of the datasets to be used in the models without feature engineering"""
...
"""Predict the label 3 on test dataset"""
...
Identify the features that collectively account for 95% of the label's variability.
...
correlation_with_target = pca_train_result_df.corrwith(train_label3)
...
for model_name, model in classification_models:
    ...
    model.fit(train_features, train_label3)
...
destination = '/content/drive/MyDrive/AI-Resources/ML/LAB01/190507U_label_3.csv'
